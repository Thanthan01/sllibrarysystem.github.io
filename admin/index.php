...
<head>
    ...
    <title>Southern Luzon Technological College Foundation Inc.</title>
...
<body style="background:#F7F7F7;"> 
    <img class="img-responsive img-rounded" src="images/slbanner.png" alt="">
    <div class="">
                ...
                <section class="login_content">
                    <form action="" method="post">
                        ...
                        <div class="separator">
                            ...
                            <br />
                            <div>
                                <h1><i class="fa fa-book" style="font-size: 26px;"></i> Southern Luzon Technological College Foundation Inc.</h1>
